...
// student.push("Ahmed", "Abdullah", "Azhan", "Arman")
// console.log(student)
...
// let educationArray = ["SSC ", "HSC", "BCS", "BS", "CS", "PHD","BCOM"]
// console.log(educationArray)



// let stu = ["Ahmed", "Ali", "Sara"];

// let obtMarks = [320, 230, 480]
...
// // let userAddStart= prompt("Enter the color which one you add in the start")
// // colorArray.unshift(userAddStart)
// // console.log(colorArray)
// // let userAddEnd = prompt("Enter the color which one you add in the end")
